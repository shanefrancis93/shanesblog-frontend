    ...
    <Layout>
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="space-y-4">
          <CollapsibleSection title="Contact Me" defaultOpen={true}>
            <div className="space-y-4 text-theme-light-text dark:text-theme-dark-text">
          ...
          <CollapsibleSection title="Work Experience" defaultOpen={false}>
            <div className="space-y-6 text-theme-light-text dark:text-theme-dark-text">
              <div>
                <h3 className="font-medium">Senior Data Scientist</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">OPTUM INSIGHTS, UNITEDHEALTH GROUP / 2022-PRESENT</p>
              ...
              <div>
                <h3 className="font-medium">Health Care Economist</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">STATE LEGISLATURE, STATE OF LOUISIANA / 2021-2022</p>
                <ul className="mt-2 space-y-2 list-disc pl-4">
              ...
              <div>
                <h3 className="font-medium">Health Care Economist</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">DEPT. OF ADMIN / REVENUE, STATE OF ALASKA / 2017 - 2020</p>
                <ul className="mt-2 space-y-2 list-disc pl-4">
                  ...
                  <li>Identified shortfalls in federal drug subsidies for the state employee plan and spearheaded procurement efforts to net the state $1.5M.</li>
                </ul>
              </div>
            </div>
          </CollapsibleSection>
          ...
          <CollapsibleSection title="Education" defaultOpen={false}>
            <div className="space-y-4 text-theme-light-text dark:text-theme-dark-text">
              <div>
                <h3 className="font-medium">Bachelor's Degree, Economics, Theatre</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Whittier College, 2016</p>
              </div>
              <div>
                <h3 className="font-medium">Master's Candidate, Health Economics</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Johns Hopkins University, 2016 – 2017</p>
              </div>
            </div>
          </CollapsibleSection>
          ...
          <CollapsibleSection title="Awards" defaultOpen={false}>
            <div className="space-y-4 text-theme-light-text dark:text-theme-dark-text">
              <div>
                <h3 className="font-medium">"Insighty" Awards for Business Impact & Advancing Insights</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Optum Strategic Insights, Minneapolis, MN / November 2023</p>
              </div>
              <div>
                <h3 className="font-medium">Computational Justice Fellowship</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Claremont Graduate University, Claremont, CA / April 2020</p>
              </div>
              <div>
                <h3 className="font-medium">Commencement Speaker</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Whittier College, Whittier, CA / May 2016</p>
              </div>

              <div>
                <h3 className="font-medium">Richard T. Clawson Service & Leadership Award</h3>
                <p className="text-theme-light-secondary dark:text-theme-dark-secondary">Whittier College, Whittier, CA / May 2016</p>
              </div>
            </div>
          </CollapsibleSection>
